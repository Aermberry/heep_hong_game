...
export default class FlyWoodenBox extends Phaser.GameObjects.Container {
    ...
    constructor(scene, x, y, answer) {
        ...
        scene.anims.create({
            key: 'correct',
            duration: 1500,
            frames: scene.anims.generateFrameNames('box_correct', { prefix: 'flybox_right', start: 0, end: 14, zeroPad: 4 }),
        })
        scene.anims.create({
            key: 'wrong',
            duration: 1500,
            frames: scene.anims.generateFrameNames('box_wrong', { prefix: 'flybox_wrong', start: 0, end: 14, zeroPad: 4 }),
        })
