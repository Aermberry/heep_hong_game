...
export default class PreloaderScene extends BasicScene {
    ...
    preload() {
        ...
        this.load.spritesheet('voiceBtn', require('../assets/img/btn_speech.png'), { frameWidth: 74, frameHeight: 83.5  })
        this.load.spritesheet('offVoiceBtn', require('../assets/img/btn_speech_off.png'), { frameWidth: 74, frameHeight: 83.5  })
