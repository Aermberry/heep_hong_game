...
export const createTutorAnimations = (anims) => {
    anims.create({
        ...
        delay: 200,
        frames: anims.generateFrameNames('tutor01Texture', { prefix: 'tutor_step_1', start: 0, end: 29, zeroPad: 4 }),
        repeat: 0,
    });
    ...
    anims.create({
        ...
        delay: 200,
        frames: anims.generateFrameNames('tutor04Texture', { prefix: 'tutor_step_4', start: 0, end: 29, zeroPad: 4 }),
        repeat: 0,
    });
