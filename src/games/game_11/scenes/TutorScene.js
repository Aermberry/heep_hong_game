...
import StartBtn from "../objects/buttons/StartBtn";
...
export default class TutorScene extends BasicScene {
    ...
    preload() {
        this.anims.create({
            key: 'tut1',
            delay: 200,
            frames: this.anims.generateFrameNames('tut1', { prefix: 'tut1', start: 0, end: 49, zeroPad: 4 }),
        });
        this.anims.create({
            key: 'tut2',
            delay: 200,
        ...
        this.anims.create({
            key: 'tut3',
            delay: 200,
            frames: this.anims.generateFrameNames('tut3', { prefix: 'tut3', start: 0, end: 54, zeroPad: 4 }),
        });
