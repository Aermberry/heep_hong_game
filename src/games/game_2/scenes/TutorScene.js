...
export default class TutorSecene extends BasicScene {
    ...
    preload() {
        ...
        this.anims.create({
            key: 'tut1',
            delay: 200,
            frames: this.anims.generateFrameNames('tut_1', { prefix: 'tut1', start: 0, end: 33, zeroPad: 4 }),
        });
        this.anims.create({
            key: 'tut2',
            delay: 200,
            frames: this.anims.generateFrameNames('tut_2', { prefix: 'tut2', start: 0, end: 34, zeroPad: 4 }),
        });
        this.anims.create({
            key: 'tut3',
            delay: 200,
            frames: this.anims.generateFrameNames('tut_3', { prefix: 'tut3', start: 0, end: 50, zeroPad: 4 }),
        });
    ...
    create() {
        ...
        let tut1 = this.add.sprite(this.getColWidth(2.2), this.getRowHeight(6), 'tut_1')
        let tut2 = this.add.sprite(this.getColWidth(6), this.getRowHeight(3), 'tut_2')
        let tut3 = this.add.sprite(this.getColWidth(9.8), this.getRowHeight(5), 'tut_3')
