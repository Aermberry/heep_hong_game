...
export default class TutorSecene extends BasicScene {
    ...
    preload() {
        this.anims.create({
            key: 'tut1',
            delay: 200,
            frames: this.anims.generateFrameNames('tut1', { prefix: 'Symbol 1', start: 0, end: 10, zeroPad: 4 }),
        });
        this.anims.create({
            key: 'tut2',
            delay: 200,
            frames: this.anims.generateFrameNames('tut2', { prefix: 'Symbol 4', start: 0, end: 9, zeroPad: 4 }),
        });
        this.anims.create({
            key: 'tut3',
            delay: 200,
            frames: this.anims.generateFrameNames('tut3', { prefix: 'Symbol 6', start: 0, end: 8, zeroPad: 4 }),
        });
