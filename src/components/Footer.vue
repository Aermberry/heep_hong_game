  ...
  <footer>
    <nav class="navbar">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            <li class="nav-item"><a href="/game/sitemap">網頁指南</a></li>
            <li class="nav-item"><a href="/game/privacy-policy">私隱政策</a></li>
            <li class="nav-item"><a href="/game/important-notices">重要告示</a></li>
